      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-emerald-100/70 text-sm sm:text-base">
            From heavy electromechanical maintenance to soft janitorial services
            and technical workforce recruitment, we keep your property operating
            at peak efficiency.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="glass-card p-6 rounded-2xl transition-all duration-300 group hover:-translate-y-1">
            ...
            <p className="text-emerald-100/70 text-xs leading-relaxed mb-4">
              Preventative and corrective maintenance for chillers, AHUs, FCUs,
              cooling towers, and IoT intelligent thermostat controls.
            </p>
          ...
          <div className="glass-card p-6 rounded-2xl transition-all duration-300 group hover:-translate-y-1">
            ...
            <p className="text-emerald-100/70 text-xs leading-relaxed mb-4">
              High & low voltage switchgear, transformer maintenance, UPS backup
              systems, diesel generator servicing, and thermal imaging.
            </p>
            <ul className="space-y-2 mb-6 text-xs text-emerald-100/80">
              <li className="flex items-center space-x-2">
          ...
          <div className="glass-card p-6 rounded-2xl transition-all duration-300 group hover:-translate-y-1">
            ...
            <p className="text-emerald-100/70 text-xs leading-relaxed mb-4">
              Pumping station maintenance, water tank sanitization, greywater
              recycling, hydro-jetting drain lines, and leak detection.
            </p>
            <ul className="space-y-2 mb-6 text-xs text-emerald-100/80">
              <li className="flex items-center space-x-2">
          ...
          <div className="glass-card p-6 rounded-2xl transition-all duration-300 group hover:-translate-y-1">
            ...
            <p className="text-emerald-100/70 text-xs leading-relaxed mb-4">
              Commercial deep cleaning, high-rise facade window washing, marble
              polishing, pest control, and landscaping upkeep.
            </p>
            <ul className="space-y-2 mb-6 text-xs text-emerald-100/80">
              <li className="flex items-center space-x-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
            ...
            <button
              onClick={() =>
                openServiceModal("Janitorial & Deep Soft Cleaning")
              }
              className="text-xs font-semibold text-emerald-400 hover:text-emerald-300 flex items-center space-x-1 cursor-pointer"
            >
          ...
          <div className="glass-card p-6 rounded-2xl transition-all duration-300 group hover:-translate-y-1">
            ...
            <p className="text-emerald-100/70 text-xs leading-relaxed mb-4">
              CCTV surveillance management, biometric access control systems,
              visitor gate barriers, and 24/7 security guard staffing.
            </p>
            <ul className="space-y-2 mb-6 text-xs text-emerald-100/80">
              <li className="flex items-center space-x-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-teal-400" />
          ...
          {/* Card 6: Manpower Recruitment & Staffing */}
          <div className="glass-card p-6 rounded-2xl transition-all duration-300 group hover:-translate-y-1 border border-emerald-500/30">
            <div className="w-12 h-12 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400 mb-5 group-hover:scale-110 transition">
            ...
            <p className="text-emerald-100/70 text-xs leading-relaxed mb-4">
              Overseas and domestic recruitment of certified MEP technicians,
              HVAC engineers, facility supervisors, and safety officers.
            </p>
            <ul className="space-y-2 mb-6 text-xs text-emerald-100/80">
              <li className="flex items-center space-x-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-5 space-y-4">
              ...
              <p className="text-emerald-100/70 text-xs sm:text-sm leading-relaxed">
                Select your facility size and service scope to estimate response
                time guarantees, dispatch coverage, and AMC plan recommendation.
              </p>
            ...
            <div className="lg:col-span-7 bg-slate-950 p-6 sm:p-8 rounded-2xl border border-emerald-500/20 space-y-6">
              ...
              <div className="p-4 rounded-xl bg-emerald-950/60 border border-emerald-500/30 flex flex-wrap items-center justify-between gap-4">
                <div>
                  ...
                  <div className="text-base font-bold text-white">
                    Amaze Enterprise{" "}
                    {areaSize > 150000 ? "Gold Platinum" : "Gold AMC"}
                  </div>
                  <div className="text-xs text-emerald-400 font-mono">
                    Guaranteed Dispatch &lt;{" "}
                    {areaSize > 150000 ? "15 Mins" : "30 Mins"}
                  </div>
                </div>

                <button
                  onClick={() =>
                    openServiceModal(`AMC Proposal - ${facilityType}`)
                  }
